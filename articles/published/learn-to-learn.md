...
That's where learning to learn is more important. We need to learn how to efficiently use Ember more so than we need to learn Ember itself. Ember will quickly be replaced by yet another tool, so reducing the time to becoming productive should be the focus of our efforts.
